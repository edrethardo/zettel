...
Gebündelt wird hier, damit Aufrufer weiter schlicht `from zettel import bons`
schreiben können — genauso wie bei `zettel.orders`.
...
2. Das Schema in `zettel/db.py` hat für nichts davon eine Spalte.
...
"""
from zettel.bons.ablage import (  # noqa: F401
...
from zettel.bons.zuordnung import (  # noqa: F401
