...
from picknick.llm.client import KonfigurationsFehler, endpunkt_aus_umgebung

ENV_WECKBEFEHL = "PICKNICK_WAKE_CMD"
...
class Wecker:
    ...
    def __init__(self, endpunkt: str | None = None, *, http=None, starter=None,
        ...
        self.weckbefehl = (weckbefehl or umgebung.get(ENV_WECKBEFEHL)
