...
**überspringt das Modell vollständig** (`picknick.path = "recipe"`): kein
...
from picknick import mengen, recipes
...
#: es drei sind und nicht zwei, steht am Schema in `picknick.db`.
KEINE_ZUTAT = None
ZUTAT = 1
HERAUSGENOMMEN = 0
